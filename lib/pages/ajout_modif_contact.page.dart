...
class AjoutModifContactPage extends StatefulWidget {
  ...
  @override
  State<AjoutModifContactPage> createState()=>AjoutModifContactPageState();
  }
class AjoutModifContactPageState extends State<AjoutModifContactPage> {
...
else  contactService.ajouterContact(contact!).then((value) {
                  Navigator.pop(context);} );
              }
